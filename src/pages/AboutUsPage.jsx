          ...
          <div className="aboutus-developer-container">
            <div className="aboutus-developer">
              ...
              <div className="aboutus-developer-identity">
                ...
                <a href="https://www.linkedin.com/in/aldowijaya/" target="_blank" rel="noreferrer">LinkedIn</a>
              </div>
            </div>
            <div className="aboutus-developer">
              ...
              <div className="aboutus-developer-identity">
                <h4>Dhoni</h4>
                <p>UI/UX Designer</p>
                <a href="https://www.linkedin.com/in/rahmatrhomadoni/" target="_blank" rel="noreferrer">LinkedIn</a>
              </div>
            </div>
            <div className="aboutus-developer">
              ...
              <div className="aboutus-developer-identity">
                <h4>Satria</h4>
                <p>Front End Developer</p>
                <a href="https://www.linkedin.com/in/satriaberlianomanzi/" target="_blank" rel="noreferrer">LinkedIn</a>
              </div>
            </div>
          </div>
        </div>
