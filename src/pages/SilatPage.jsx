...
import batuKiri from "../assets/img-background/silat-batu-1.png";
import batuKanan from "../assets/img-background/silat-batu-2.png";
    ...
    <div id='silat-page'>
      ...
      <div className='silat'>
        <div className='silat-background'>
          ...
          <div className='silat-batu-background-container'>
            <img src={batuKiri} alt='gambar batu' id='batu-kiri' />
            <img src={batuKanan} alt='gambar batu' id='batu-kanan' />
          </div>
